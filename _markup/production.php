...
<body class="inner-page production-page">
...
<main>
	<section class="content-box">
		<div class="center">
			<h2 class="backlink-title"><span><a href="">ბილიონის წარმოება</a></span></h2>
			...
			<div class="production-list">
				<div class="row">
					...
					<a href="" class="product">
						<div class="image-box">
							<img src="https://billion.404.ge/_markup/assets/img/blini.jpg" alt="" loading="lazy">
						</div>
