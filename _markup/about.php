...
<head>
	...
	<link rel="preload" as="image" crossorigin="anonymous" href="https://billion.404.ge/_markup/assets/img/inner.top.wave.svg">
	<link rel="preload" as="image" crossorigin="anonymous" href="https://billion.404.ge/_markup/assets/img/footer.wave.svg">
	<link rel="preload" as="image" crossorigin="anonymous" href="https://billion.404.ge/_markup/assets/img/foods.bg.svg">
</head>
...
<main>
	<section class="content-box">
		<div class="center">
			<h1 class="sec-title">ჩვენ შესახებ</h1>

			<div class="row">
				<div class="col-md-6">
					<div class="image-box">
						<img src="https://billion.404.ge/_markup/assets/img/about.jpg" alt="ფასდაკლებები" loading="lazy">
					</div>
				</div>
				<div class="col-md-6">
					<div class="content">
						<h3>ჩვენი სუპერმარკეტის შესახებ</h3>
				...
				<div class="custom-row">
					...
					<div class="data">
						<div class="content">
							...
							<div class="number"><span>72k+</span></div>
							<p>მოწონება სოციალურ ქსელში</p>
						</div>
					</div>
					...
					<div class="data">
						<div class="content">
							...
							<div class="number"><span>73k+</span></div>
							<p>გამომწერი სოციალურ ქსელში</p>
						</div>
					</div>
					...
					<div class="data">
						<div class="content">
							...
							<div class="number"><span>1000k+</span></div>
							<p>პროდუქტი</p>
						</div>
					</div>
				</div>
